...
public class CdLogic {
    ...
    private String edit(String userCommand, String toUpdate, String updated) throws IOException {
	...
	private String search(String userCommand) {
		...
		//Object Task;
		//Task.toDisplay.clear() ;
		//for(int i=0; i<arguments.length; i++){
			//if (Task.getDisplayList(i) == arguments[i]){
			//	Task.toDisplay.add(i) ;
		//	}
	//	}
		return null;
	}
