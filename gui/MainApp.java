...
public class MainApp extends Application {
	...
	public MainApp() {
		...
		// Dummy data
		/*
		 * taskData.add(new Task("Do homework 1")); taskData.add(new
		 * Task("Do homework 2")); taskData.add(new Task("Do homework 3"));
		 * taskData.add(new Task("Do homework 4")); taskData.add(new
		 * Task("Do homework 5")); taskData.add(new Task("Do homework 6"));
		 * taskData.add(new Task("Do homework 7")); taskData.add(new
		 * Task("Do homework 8"));
		 */
	}
