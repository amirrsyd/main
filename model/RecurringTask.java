...
/**
 * Model class for a recurring task. Recurrence states the number of times
 * for recurring and day states the day of the week to recur on if recurring
 * weekly. However if the task recurs monthly, then day is set to null.
 * 
 * @author Qiyuan.
 */
public class RecurringTask extends Task {
	...
	/**
	 * Constructor for setting all values of a recurring task and instantiating it.
	 * Assumes recurrence on a date monthly.
	 *
	 ...
	 * @param recurrence         Recurrence of the task.
	 */
	public RecurringTask(String taskName, String taskDescription, LocalDate startDate,
			LocalTime startTime, LocalDate endDate, LocalTime endTime, int recurrence) {
	...
	/**
	 * Constructor for setting all values of a recurring task and instantiating it.
	 * Recurrence occur weekly on the specified day.
	 *
	 * @param taskName           Name of the task.
	 * @param taskDescription    Description of the task.
	 * @param startDate          Starting date of the task.
	 ...
	 * @param endTime            Ending time of the task.
	 * @param recurrence         Recurrence of the task.
	 * @param day                day of the week to recur on.
	 */
	public RecurringTask(String taskName, String taskDescription, LocalDate startDate,
			LocalTime startTime, LocalDate endDate, LocalTime endTime, int recurrence, Day day) {
		this.taskName = new SimpleStringProperty(taskName);
		this.comment = new SimpleStringProperty(taskDescription);
		this.startDate = new SimpleObjectProperty<LocalDate>(startDate);
		this.startTime = new SimpleObjectProperty<LocalTime>(startTime);
	...
	public RecurringTask(Task task, int recurrence) {
		...
		this.startDate = new SimpleObjectProperty<LocalDate>(task.getStartDate());
		this.startTime = new SimpleObjectProperty<LocalTime>(task.getStartTime());
	 ...
	 * @param day           day of the week to recur on.
	 */
	public RecurringTask(Task task, int recurrence, Day day) {
		this.taskName = new SimpleStringProperty(task.getTaskName());
		this.comment = new SimpleStringProperty(task.getComment());
		this.startDate = new SimpleObjectProperty<LocalDate>(task.getStartDate());
		this.startTime = new SimpleObjectProperty<LocalTime>(task.getStartTime());
	 ...
	 * @param day    day of the week to recur on.
	 */
	public void setRecurrenceDay(Day day) {
		this.day = day;
	}
}
